...
**Public SKUs** (`ALPENGLOW_EDITION`, default `potato`): `potato` (small OS: old fast + minimal), `desktop`, `internet`. Matrix and dated measurements: `docs/editions-and-roles.md`.
